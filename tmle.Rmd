...
system.time({
  ...
  result_violence2 = estimate_effect(Y=data_violence$any_violence, 
                          ...
                          cv_folds = cv_folds, cluster=cluster,
      	  	  						crossvalidate=F, outer_cv_folds = 5)
})
result_violence2
...
if ("qinit_cv" %in% names(result_violence2)) {
	...
	summary(result_violence2$qinit_cv)
	wgts = cvSL_review_weights(result_violence$qinit_cv)
	print(wgts, type = "html")

	summary(result_violence2$ghat_cv)
	wgts = cvSL_review_weights(result_violence$ghat_cv)
	print(wgts, type = "html")
