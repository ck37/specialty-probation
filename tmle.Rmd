...
```{r}
custom_lib = create_SL_lib(cols = ncol(W_arrest), detailed_names = T)
...
system.time({
  # Takes about 5 minutes.
  result_arrest2 = estimate_effect(Y=data_arrest$any_arrest, A=data_arrest$treatment,
                      W=W_arrest, parallel = "multicore", sl_lib = sl_lib,
