...
lib7 = create_SL_lib(nc, xgb="small", rf=T, glmnet=T, glmnet_size=11, gam=T, detailed_names = T)
# Full library.
lib8 = create_SL_lib(nc, xgb=T, rf=T, glmnet=T, glmnet_size=11, gam=T, detailed_names = T)

libs = list(lib1, lib2, lib3, lib4, lib5, lib6, lib7, lib8)
...
save(results, file="data/lib-robustness-analysis.RData")
```
